...
class CmdError:
    MESSAGE = { 2: 'Код ошибки - недопустимое количество параметров (>255)',
                3: 'Код ошибки - отрицательное значение номера записи',
                4: 'Код ошибки - превышено время ожидания полного набора данных',
                5: 'Код ошибки - команда не может быть обработана',
                6: 'Код ошибки - нарушение структуры телеграммы',
                7: 'Конфигурационная запись объекта. Код ошибки - недопустимый индекс объекта',
                8: 'Конфигурационная запись объекта. Код ошибки - объект с таким индексом не сконфигурирован',
                9: 'Конфигурационная запись объекта. Код ошибки - объект с таким индексом не активен',
                10: 'Конфигурационная запись объекта. Параметр с указанным идентификатором не найден'}

    # C_EINVALNUMPAR = 2  # Код ошибки - недопустимое количество параметров (>255)
    # C_ENEGSEQNUM = 3  # Код ошибки - отрицательное значение номера записи
    # C_ETIMEOUT = 4  # Код ошибки - превышено время ожидания полного набора данных
    # C_EINVALCMD = 5  # Код ошибки - команда не может быть обработана
    # C_ESTRUCTCMD = 6  # Код ошибки - нарушение структуры телеграммы
    # C_EINVIDX = 7  # Конфигурационная запись объекта. Код ошибки - недопустимый индекс объекта
    # C_ENOTCONFED = 8  # Конфигурационная запись объекта. Код ошибки - объект с таким индексом не сконф
...
class PlcCommandConstants:
    ...
    # ответная команда
    RETURN_CMD_READ_VARIABLE_CONFIG = 530
    RETURN_CMD_READ_VARIABLE_FORMULA_CONFIG = 531
...
class PlcAddressBlockConstants:
    ...
    # # Второй поток
    CMD_DATA_BLOCKS_WD_ADDRESS = 2 # 2001
    CMD_DATA_BLOCKS_BASE_ADDRESS = 2000
    CMD_DATA_BLOCKS_REC_LAST_ADDRESS = 6 # 2003
    CMD_DATA_BLOCKS_REC_ADDRESS = 18 #12 # 2009
    CMD_DATA_BLOCK = 101
    # Первый поток
    ...
    # # Второй поток
    RETURN_DATA_BLOCKS_WD_ADDRESS = 12 # 3006
    RETURN_DATA_BLOCKS_BASE_ADDRESS = 3000
    RETURN_DATA_BLOCKS_REC_LAST_ADDRESS = 24 # 3012
